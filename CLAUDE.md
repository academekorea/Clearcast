...
| Store | Purpose |
|-------|---------|
| podlens-jobs | Analysis job state |
| podlens-shows | Show intelligence profiles |
| transcripts | AssemblyAI transcript results |
| transcript-cache | 7-day video transcript cache |
| yt-cache | YouTube caption cache |
...
| AUDIO_SERVICE_URL | Railway yt-dlp service |
...
- Brand: Podlens (not Clearcast/Audlens)
